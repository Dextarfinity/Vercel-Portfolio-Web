...
<section
  ...
  >
    <div
      class="lg:col-span-2 sm:pl-2 md:col-span-3 md:text-left text-center"
    >
    <div class="parent">
      ...
      <div>
        <h5 class="font-medium text-gray-600 dark:text-gray-200 mt-5">
          Hello Welcome
        </h5>
        <h1
      ...
      <div class="md:w-96 md:ml-auto flex mt-9 gap-2 dark:text-gray-300">
        ...
        <p class="text-xs text-balance leading-5 max-w-md px-2 mx-auto">
          Experienced frontend developer with a passion of well user-friendly website creation.
        </p>
      </div>
      <div
      ...
      >
        ...
        <div class="flex justify-end gap-3">
          ...
          <a href="https://www.linkedin.com/in/dexter-pimentel-07302a2a7/" class="social-icon">
    ...
    <div
        ...
        <li>
          <button class="btn btn-outline lg:mt-10 md:mt-0 mt-10" id="downloadFile" @click="handleDownload">
  ...
  <div class="">
    <div class="text-center text-balance aboutintro">
      ...
      <p class="px-2 mt-3 text-gray-500">
        I am a well-versed in HTML, CSS, and JavaScript, and some of other frameworks and libraries, which allows me to implement interactive features. Additionally, I have experienced working as a Graphic Designer such as Adobe Illustrator, Photoshop, Premiere and After Effects.
      </p>
    </div>
    <div
...
>
  <div class="pb-10">
    <div class="text-center contacthead">
      <h3>Contact Me</h3>
      <p class="px-2 mt-3 text-gray-500">
        Looking for a web designer to create a sleek, modern, and user-friendly site? I specialize in building websites that not only look great but also work seamlessly across all devices. Whether you need a portfolio, e-commerce, or a business site, I can help you create something unique that truly represents your brand.

        Feel free to get in touch to discuss your project, get a quote, or ask any questions! Let's make your online presence stand out.
      </p>
    </div>
    <div
      class="mt-12 md:relative flex flex-col gap-5 sm:max-w-full mx-auto max-w-xs"
    >
      <div
      ...
      >
        <h3 class="font-semibold text-2xl border-b pb-4 border-gray-600">
          Find or Visit Me <span class="text-primary">.</span><i class="text-primary fa-solid fa-turn-down"></i>
        </h3>
        <div class="py-4">
